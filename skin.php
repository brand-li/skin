...
/**
 * Plugin Name:       Skin
 * Plugin URI:        https://github.com/brand-li/skin
 * Description:       Skin UI. Customizing has never been so easy, with so many options, easy to use and with the posibility to change everything in seconds.
 * Version:           1.0.2
 * Author:            Brandli
